...
Please provide a response in this exact JSON format:
{
  ...
  "keyPoints": [
    "Key learning point 1 - essential concept to understand",
    "Key learning point 2 - important fact or principle",
    "Key learning point 3 - core idea or theory",
    "Key learning point 4 - practical application or example",
    "Key learning point 5 - connection to broader context"
  ]
}
