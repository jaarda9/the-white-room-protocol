          ...
          <div className="flex flex-col items-center justify-center">
            <button
              onClick={() => {
                if (allCompleted) {
                  systemSound.playQuestComplete();
                  toast.success('SPIRITUAL DIRECTIVES FULFILLED!');
                }
              }}
              ...
              title={allCompleted ? 'All spiritual training complete' : 'Complete all spiritual directives first'}
            >
              <Check className="w-7 h-7 stroke-[3]" />
            </button>

            <div className="mt-2 text-center font-mono text-[11px] text-white/50">
              [{completedCount} of {spiritualQuests.length} directives fulfilled]
            </div>
          </div>
