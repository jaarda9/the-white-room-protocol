...
export const checkSystemEvents = (profile: UserProfile): SystemEvent[] => {
  ...
  // The old nightly missed-quest HP penalty toast is gone — a miss now surfaces as an actual
  // Penalty Quest assignment (see penalty-system.ts's checkAndAssignPendingPenalty(), wired
  // from Dashboard.tsx), not a passive [SYSTEM] notice here.
